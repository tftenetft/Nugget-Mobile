...
struct ToolsView: View {
    ...
    @State var tools: [ToolCategory] = [
        .init(title: "Sparserestore Tweaks", pages: [
            ...
            .init(page: .FeatureFlags, view: AnyView(FeatureFlagsView()), title: NSLocalizedString("Feature Flags", comment: "Title of tool"), imageName: "flag", minVersion: Version(string: "17.2")),
            .init(page: .Eligibility, view: AnyView(EligibilityView()), title: NSLocalizedString("Eligibility", comment: "Title of tool"), imageName: "mappin", minVersion: Version(string: "17.2")/*Version(string: "17.4")*/),
